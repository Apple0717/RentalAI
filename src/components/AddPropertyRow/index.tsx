    ...
    return (
        ...
        >
            <Flex gap="9px" flex={1} alignItems="center">
                ...
                <Heading size="headings" as="h6" color="blue_gray.700_02" fontWeight={600} alignSelf="flex-end">
                    {propertyTitle}
                </Heading>
            </Flex>
            <Image src="images/img_link_square_02_blue_gray_100.svg" alt="Add Property" h="20px" />
        </Flex>
    );
}